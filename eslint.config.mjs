...
const commonRules = () => ({
    ...
    'no-unused-vars': [
        'warn', // замість "error" ставимо "warn", щоб не блокувати збірку
        {
            vars: 'all', // застосовувати до всіх змінних
            args: 'none', // не перевіряти на використання аргументи функцій
            ignoreRestSiblings: false, // не ігнорувати решту сиблінгів
            caughtErrors: 'none', // не перевіряти на використання помилки
        },
    ],
...
export const customConfig = {
    ...
    settings: {
        'import/resolver': {
            typescript: {
                alwaysTryTypes: true, // <-- makes it find `@` paths and types too
...
export default [
    ...
    { ignores: ['*', '!src/', 'eslint.config.*'] },
    {
        languageOptions: {
            ...
            parserOptions: {
                project: './tsconfig.json', // for strict rules like no-floating-promises
                sourceType: 'module',
                ecmaVersion: 2020,
            },
