                    ...
                    return [2 /*return*/, (React.createElement("main", { className: "pt-20 " },
                            React.createElement(index_1.GlobeWrapper, null,
                                React.createElement("div", { className: "cursor-default w-full max-w-360 mx-auto mt-25 text-left px-5", id: "about" },
                                    React.createElement("div", { className: "flex flex-col relative z-10 w-full max-w-5xl\n                    " },
                                        ...
                                        React.createElement("p", { className: "mt-6 font-semibold text-xl text-gray-30 max-w-4xl  text-left" }, t('headerTitle.description')),
                                        React.createElement("div", { className: "mt-8 text-right" },
                                            React.createElement(button_1.Button, { variant: "secondary", asChild: true, size: "default", className: "pointer-events-auto p-0 h-11 " },
