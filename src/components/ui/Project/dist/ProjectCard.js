...
function ProjectCard(_a) {
    ...
    var topics = (_b = project.topics) !== null && _b !== void 0 ? _b : [];
    var _e = react_1.useState(((_c = project.preview) === null || _c === void 0 ? void 0 : _c.trim()) || PROJECT_PREVIEW_PLACEHOLDER), previewSrc = _e[0], setPreviewSrc = _e[1];
    var detailsUrl = (_d = project.github) !== null && _d !== void 0 ? _d : project.website;
    react_1.useEffect(function () {
        var _a;
        setPreviewSrc(((_a = project.preview) === null || _a === void 0 ? void 0 : _a.trim()) || PROJECT_PREVIEW_PLACEHOLDER);
    }, [project.preview]);
    return (React.createElement("div", { className: "project-card-anim card-hover-effect animate-fade-in-up flex h-full min-h-[320px] flex-col gap-3 rounded-2xl bg-card p-4 backdrop-blur-md transition-all min-[581px]:min-h-[360px] min-[581px]:gap-4 min-[581px]:p-5 min-[900px]:p-6" },
        React.createElement("h3", { className: "h-14 overflow-hidden text-xl leading-tight font-semibold text-white min-[581px]:h-16 min-[581px]:text-2xl" }, project.name),
        React.createElement("div", { className: "relative h-40 overflow-hidden rounded-xl bg-gray-200 min-[581px]:h-44" },
            React.createElement(image_1["default"], { alt: project.name + " preview", className: "h-full w-full object-contain", onError: function () { return setPreviewSrc(PROJECT_PREVIEW_PLACEHOLDER); }, src: previewSrc, fill: true, sizes: "(max-width: 580px) 100vw, 360px" })),
        React.createElement("div", { className: "flex h-9 flex-wrap items-center gap-2 overflow-hidden" },
            project.website ? (React.createElement("a", { className: "inline-flex h-8 items-center gap-1 rounded-md bg-secondary px-3 py-1.5 text-xs font-semibold text-secondary-foreground transition hover:opacity-90", href: project.website, rel: "noreferrer", target: "_blank" },
