        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, githubApi_1.fetchGithubProjects()];
                case 1:
                    projects = _a.sent();
                    return [4 /*yield*/, prisma.$transaction(function (tx) { return __awaiter(_this, void 0, void 0, function () {
                            return __generator(this, function (_a) {
                                switch (_a.label) {
                                    case 0: return [4 /*yield*/, tx.githubProject.deleteMany()];
                                    case 1:
                                        _a.sent();
                                        if (projects.length === 0) {
                                            return [2 /*return*/];
                                        }
                                        return [4 /*yield*/, tx.githubProject.createMany({
...
exports.getGithubProjectsFromDb = getGithubProjectsFromDb;
